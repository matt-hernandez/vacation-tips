    ...
    return (
      <section>
        ...
        <p>
          ...
          being approved for a particular credit card with a bank. The banks in this case are Chase
          and Amex. Both banks have several cards that allow you to enter into the rewards program.
          The most popular cards with Chase are the Sapphire Preferred and the Sapphire Reserve.
          Amex has their Gold and Platinum cards.
        </p>
        <p>
          Every time you put on expenses on this card, the bank rewards you with points. Typically,
          you&#x2019;ll earn 1 point per dollar. So a $14.38 purchase will net you 14 points.
        </p>
        <p>
          But sometimes the banks will give you more points based on what kind of purchase you made.
          For example, the Chase Sapphire Preferred rewards their credit card users 2x points on
          travel and dining purchases. So if your $14.38 was spent on a meal at a restaurant,
          you&#x2019;ll get 2 x 14 points, or 28 points.
        </p>
        <p>
          ...
          $450 annual fee that is not waived the first year. If you get a Chase Sapphire Preferred,
          the annual fee is $0 the first year and only $95 after that.
        </p>
        <p>
        ...
        <p>
          ...
          card will require some research. Take notes of the ones that match your affordability and
          lifestyle, but don&#x2019;t pick one yet.
        </p>
      </section>
    );
  }
